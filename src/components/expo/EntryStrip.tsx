    ...
    >
      ...
      >
        {[
          ...
          <div key={l} className="flex items-center gap-0.5 sm:gap-2">
            <span
              className="font-black text-[11px] sm:text-2xl"
            ...
            {i < 2 && (
              <span className="font-bold text-[10px] sm:text-base" style={{ color: isLight ? '#9CA3AF' : '#374151', marginLeft: 1 }}>·</span>
            )}
          </div>
        ))}
      </motion.div>
